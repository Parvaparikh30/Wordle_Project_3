...
users_database = Database('sqlite+aiosqlite:///var/users.db')
...
connection = sqlite3.connect('./var/primary/mount/games.db')
cursor = connection.cursor()


correct_str = 'insert into secret_word(word) values '
for i in list(correct_word):
    correct_str += '("'+ i +'"),'
correct_str = correct_str[:-1] + ';'


valid_str = 'insert into valid_words(word) values '
